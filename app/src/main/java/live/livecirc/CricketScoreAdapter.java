...
public class CricketScoreAdapter extends RecyclerView.Adapter<CricketScoreAdapter.CricketScoreViewHolder> {
    ...
    ScoreModel liveScore;
    Context context;
    Boolean matchStarted;
    ArrayList<ScoreModel> sc=new ArrayList<>();
    public static final String TAG = "CricketScoreAdapter";

    public CricketScoreAdapter(ScoreModel liveScore, Context context, Boolean matchStarted) {
        this.liveScore = liveScore;
        this.context = context;
        this.matchStarted = matchStarted;
    }

    public CricketScoreAdapter(Context context) {
        this.context = context;

    }

    public void updateList(ScoreModel liveScore) {
        sc.clear();
        this.sc.add(liveScore);
        //this.liveScore = liveScore;
    ...
    public CricketScoreViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new CricketScoreViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(CricketScoreViewHolder holder, int position) {

        ScoreModel scoreModel=sc.get(position);
