...
public class ScoreFragment extends Fragment {
    ...
    String score;
    private RecyclerView scoreRecy;
    private CricketScoreAdapter adapter;
    private OnFragmentInteractionListener mListener;
    private Handler handeler=new Handler();
    private ScoreModel sm;
    private TextView scorev,match_st,inningsRequirement;
    ...
    public static ScoreFragment newInstance(String param1, boolean param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        scorev=(TextView)v.findViewById(R.id.tvScore);
        match_st=(TextView)v.findViewById(R.id.tvMatchStarted);
        inningsRequirement=(TextView)v.findViewById(R.id.tvInningsRequirement);
        getScore();
        return v;
    }

    private void getScore() {
        prgressDialog=new ProgressDialog(getActivity());
        prgressDialog.show();
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    System.out.println("object "+   jsonObject+ " "+"param1 "+mParam1);
                    score = "";
                    if(mParam2) {
                        try {
